...
//     $routes->get('/', 'Citas::index');
//     $routes->get('getEvents', 'Citas::getEvents');
//     $routes->post('store', 'Citas::store');
//     $routes->post('update/(:num)', 'Citas::update/$1');
// });


//ya funcioan esta parte de los filtros con login  

// $routes->group('pacientes', function($routes) {
//     $routes->get('/', 'Pacientes::index', ['filter' => 'isLoggedIn']); // ✔️ Correcto
// });
// $routes->group('pacientes', ['filter' => 'isLoggedIn'], function($routes) {
//     $routes->get('/', 'Pacientes::index'); // ✔️ Todas las rutas del grupo estarán protegidas
// });